---
layout: default
title: "FCSC 2020 - hello rootkitty"
category: "pwn - medium"
...
## FCSC 2020 - pwn - hello rootkitty - medium
...
## The vulnerability
Inside the `ecsc_sys_getdents64` function strcpy is used to copy our file name into a buffer, we can control the file name by making a secondary, dummy flag file which starts with 'ecsc_flag_' and there is no bounds check on how big the file name can be:
```
